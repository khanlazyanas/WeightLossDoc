...
const Journal = () => {
  // Mock Database for Articles (Later you can connect this to a real backend)
  const articles = [
    {
      id: 1,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1551076805-e18690c5e53b?auto=format&fit=crop&q=80&w=1000",
      featured: false
    }
  ];
    ...
    <div className="font-sans text-[#0f172a] bg-white selection:bg-[#10b9bd] selection:text-white min-h-screen relative overflow-hidden">
      ...
      <section className="py-12 px-4 sm:px-6 relative z-10">
        <div className="container mx-auto max-w-7xl">
          <div className="group relative w-full bg-[#0f172a] rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden shadow-2xl border-[8px] sm:border-[12px] border-white flex flex-col lg:flex-row cursor-pointer hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.3)] transition-shadow duration-700">
            ...
            <div className="w-full lg:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center relative">
               <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-[#10b9bd]/10 to-transparent pointer-events-none"></div>
            ...
            {regularArticles.map((article) => (
              <div key={article.id} className="group flex flex-col bg-white rounded-[2rem] border border-slate-200 overflow-hidden shadow-sm hover:shadow-[0_20px_40px_-15px_rgba(16,185,189,0.15)] hover:-translate-y-2 transition-all duration-500 cursor-pointer">
                <div className="w-full aspect-[4/3] relative overflow-hidden bg-slate-100 border-b border-slate-100">
                  ...
                  <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md text-[#0f172a] px-3 py-1.5 rounded-lg text-[8px] font-black uppercase tracking-widest border border-white">
                    {article.category}
                  </div>
                </div>
        ...
        <div className="container mx-auto max-w-3xl relative z-10 flex flex-col items-center">
          ...
          <form className="relative w-full max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
             <input 
               ...
               className="w-full bg-slate-900/80 border border-slate-700/80 rounded-2xl py-5 sm:py-6 pl-6 pr-32 text-[10px] sm:text-xs font-black uppercase tracking-widest text-white placeholder:text-slate-500 focus:outline-none focus:border-[#10b9bd] transition-all backdrop-blur-md"
             />
